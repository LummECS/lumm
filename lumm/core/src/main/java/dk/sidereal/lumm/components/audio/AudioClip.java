...
import dk.sidereal.lumm.util.Utility;
...
public abstract class AudioClip {
     ...
     */
    private Audio.AudioChannel channel;
     ...
     * @param channel  Audio channel to get sound settings from.
     * @param source   source to add the clip to. It can be null if you do not plan
     *                 on using sound panning
     */
    public AudioClip(String filepath, Audio.AudioChannel channel, AudioSource source) {
     ...
     *
     * @param filepath               path to the file
     * @param customAudioChannelName name of a custom audio channel, for setting different values
     * @param source                 source to add the clip to. It can be null if you do not plan
     *                               on using sound panning
     */
     ...
     * @param pan    value, present for convenience if necessary.
     * @param pitch  pitch value, present for convenience if necessary.
     */
     ...
     * as Music objects do not support pitch shifts for example)
     *
     * @param volume volume value, present for convenience if necessary.
     ...
     * @param volume volume value, present for convenience if necessary.
     * @param pan    value, present for convenience if necessary.
     * @param pitch  pitch value, between 0.5 ( half speed) and 2( 2x speed)
     */
     ...
     *
     * @param listener The audio listener. If null is passed, the source will roll
     ...
     * @param category
     */
    public final void setAudioChannel(Audio.AudioChannel category) {
     ...
     * @return
     */
    public final Audio.AudioChannel getAudioChannel() {
        return channel;
    }
     ...
     *
     * @param volume value between 0 (mute) and 1 (full volume)
     */
    ...
    final void updateInternalData() {
        ...
        // master volume
        float volume = Lumm.audio.getVolume(Audio.AudioChannel.Master);
