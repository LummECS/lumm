                ...
                if (wrapper.action.equals(Net.getSession)) {
                    ...
                    if (wrapper.success && wrapper.fullObject.has("object")) {
                        ...
                        try {
                            ...
                            Lumm.debug.onFinishLogListener = new Debug.OnFinishLogListener() {

                                @Override
                                public void finishLog(Debug.Log log, String logType) {
                                    ...
                                    try {
                                        ...
                                        for (int i = 0; i < log.getMessages().size(); i++) {
                                            Debug.LogMessage logMessage = log.getMessages().get(i);
                    ...
                    if (wrapper.success && wrapper.fullObject.has("object")) {
                        try {
                            ...
                            Debug.LogMessage message = Lumm.debug.new LogMessage(Debug.Log.LOG_ERROR, DEFAULT_TAG, wrapper.message, is);
