 ...
 * finger to trigger an action is to use {@Link Input.InputAction}.
 * <p>
 * To listen to any actions to trigger an event( for uses such as key bindings),
 * use {@link Input.Action#ANY_ACTION}
 * <p>
 * User must implement the {@link #onClick(TouchData)} method , getting access to
