...
public class Net extends LummModule {
	...
	private String serverPath = "http://lummenvironment.vmm2wnt24w.eu-central-1.elasticbeanstalk.com/com.sidereal.lumm/api";
	...
	public void onCreate() {
		...
		requestQueue = new HashSet<NetRequestQueue>();
