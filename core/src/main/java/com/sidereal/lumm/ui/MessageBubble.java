...
import com.sidereal.lumm.components.renderer.sprite.SpriteBuilder;
import com.sidereal.lumm.components.renderer.sprite.SpriteDrawer;
import com.sidereal.lumm.ui.TextBuilder.Anchor;
import com.sidereal.lumm.ui.TextBuilder.Paragraph;
...
public class MessageBubble extends ConcreteLummObject {
	...
	public void onCreate(Object... params) {
		...
		clickable.addOnClickListener(targetInputProcessor, Action.ANY_ACTION, new OnClickListener() {
		...
		texts = new ArrayList<MessageBubbleText>();
		inTransition = true;
