...
import com.sidereal.lumm.components.triggers.TriggerArea.TriggerAreaConnection;
...
public class Collider extends ConcreteLummComponent {
	...
	private final List<TriggerAreaConnection> collisionAreaStatuses;

	private final List<Collider> tempColliderStatuses;
	private List<TriggerAreaConnection> tempCollisionAreaStatuses;
