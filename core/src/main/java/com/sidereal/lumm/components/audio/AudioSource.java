 ...
 * {@link AudioClip#AudioClip(String, com.sidereal.lumm.architecture.core.Audio.AudioChannel, AudioSource)}
 ...
 * 
 * @param obj
 *            The object to pass the component to.
 */
public class AudioSource extends ConcreteLummComponent {
	 ...
	 * 
	 * @param listener
	 *            {@link AudioListener} instance tied to the {@link AudioClip}
	 ...
	 *            path to the file
	 * @param unload
	 *            whether to unload to asset or not
	 ...
	 * 
	 * @param clipPath
	 *            The path to the clip you want to add a task for
	 * @param audioTask
	 *            The type of task you want the system to perform
	 * @param delay
	 *            The delay in seconds from calling this method to running the
	 *            task
	 */
	 ...
	 * 
	 * @param clip
	 *            The clip tied to the task you want to perform
	 * @param audioTask
	 *            The type of task you want the system to perform
	 * @param delay
	 *            The delay in seconds from calling this method to running the
	 ...
	 *            task
	 * @param useRealTime
	 *            Whether to use real time for delaying ( as opposed to the game
	 ...
	 *            Whether to use real time for delaying ( as opposed to the game
	 *            time, which is affected by {@link Time#getTimeScale()}.
	 * @param onCompletionEvent
	 *            Event to run on completion. Some {@link AudioClip}
