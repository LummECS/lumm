...
public class TriggerArea {
	 ...
	 * 
	 * @param width
	 *            The new width of the collision area.
	 * @param centerAroundObject
	 *            Whether to center the object on the x axis, updating the value
	 ...
	 * 
	 * @param height
	 *            The new height of the collision area.
	 * @param centerAroundObject
	 *            Whether to center the object on the x axis, updating the value
	 *            returned by {@link #getOffsetX()}.
	 */
	 ...
	 * 
	 * @param centerAroundObject
	 *            Whether to center the object on the x and y axis, updating the
	 ...
	 * 
	 * @param offsetX
	 *            x-axis collision area offset from the object's position
	 */
	 ...
	 * 
	 * @param offsetY
	 *            y-axis collision area offset from the object's position
	 */
