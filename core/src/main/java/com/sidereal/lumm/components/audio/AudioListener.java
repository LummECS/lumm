...
import com.sidereal.lumm.components.audio.AudioClip.AudioListenerInteraction;
...
public class AudioListener extends ConcreteLummComponent {
	 ...
	 * {@link AudioListenerInteraction#Auto}, the target volume, pitch and
	 ...
	 * set to {@link AudioListenerInteraction#Auto}, the clips will get their
	...
	private void updateAudioClips() {
		for (int i = 0; i < audioClips.size; i++) {
			if (audioClips.get(i).audioListenerInteraction == AudioListenerInteraction.Target)
	...
	static void updateAutomaticAudioClips() {
		for (int i = 0; i < automaticAudioclips.size; i++) {
			if (automaticAudioclips.get(i).audioListenerInteraction == AudioListenerInteraction.Auto)
